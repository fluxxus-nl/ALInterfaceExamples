codeunit 89798 "Valid VIES Check" implements "VAT Validation Handling Interface"
// Mock of codeunit 248 "VAT Lookup Ext. Data Hndl" returning a invalid log entry
{
    ...
    begin
        SetValidVATRegistrationLog(VATRegistrationLog);
